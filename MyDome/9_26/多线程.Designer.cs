namespace _9_26 {
	partial class 多线程 {
		...
		private void InitializeComponent() {
			...
			this.button2.Size = new System.Drawing.Size(173, 106);
			this.button2.TabIndex = 1;
			this.button2.Text = "程序的线程开始运行方法";
			...
			this.Name = "多线程";
			this.Text = "Form1";
			this.Load += new System.EventHandler(this.多线程_Load);
